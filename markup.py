def to_html(page):
    ...
    page = page.replace("<mscroggs.co.uk>", "<span style='font-family:comfortaa;font-weight:normal'><span style='color:#2EA3D0'>mscroggs</span><span style='color:FFA366'>.co.uk</span></span>")
